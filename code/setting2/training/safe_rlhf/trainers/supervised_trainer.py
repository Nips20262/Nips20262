...
# https://github.com/PKU-Alignment/safe-rlhf/safe_rlhf/trainers/supervised_trainer.py
# ==============================================================================
        ...
        for epoch in range(self.args.epochs):
            ...
            for batch in self.train_dataloader:
                ...
                if self.global_step % self.args.save_interval == 0:
                    ...
                    self.model.save_16bit_model(self.args.output_dir, save_filename=f'pytorch_model_step_{self.global_step}.bin')
